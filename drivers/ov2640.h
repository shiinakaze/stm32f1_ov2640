...
#define RCC_APB_OV2640 (RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC | RCC_APB2Periph_AFIO)

// Control Pin
// SIO_C and SIO_D are defined in sccb.h

#define PCLK_GPIO   GPIOA
#define CTRL_GPIO   GPIOB
...
#define OV2640_PCLK GPIO_ReadInputDataBit(PCLK_GPIO, PCLK_PIN)
#define OV2640_HREF GPIO_ReadInputDataBit(CTRL_GPIO, HREF_PIN)
#define OV2640_VSYNC GPIO_ReadInputDataBit(CTRL_GPIO, VSYNC_PIN)
...
typedef struct
{
    uint32_t vsync_high_us;
    uint32_t href_count;
    uint32_t pclk_count;
    float href_freq;
    float pclk_freq;
} OV2640_SignalMeasure_t;
